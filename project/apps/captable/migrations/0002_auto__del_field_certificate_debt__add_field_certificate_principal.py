...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Certificate.debt'
        db.delete_column(u'captable_certificate', 'debt')

        # Adding field 'Certificate.principal'
        db.add_column(u'captable_certificate', 'principal',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Certificate.debt'
        db.add_column(u'captable_certificate', 'debt',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Deleting field 'Certificate.principal'
        db.delete_column(u'captable_certificate', 'principal')
