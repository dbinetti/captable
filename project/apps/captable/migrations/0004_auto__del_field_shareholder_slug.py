...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Shareholder.slug'
        db.delete_column(u'captable_shareholder', 'slug')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Shareholder.slug'
        raise RuntimeError("Cannot reverse this migration. 'Shareholder.slug' and its values cannot be restored.")
