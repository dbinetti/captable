...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Certificate.vesting_notes'
        db.add_column(u'captable_certificate', 'vesting_notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'Certificate.vesting_immediate'
        db.alter_column(u'captable_certificate', 'vesting_immediate', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):
        # Deleting field 'Certificate.vesting_notes'
        db.delete_column(u'captable_certificate', 'vesting_notes')


        # Changing field 'Certificate.vesting_immediate'
        db.alter_column(u'captable_certificate', 'vesting_immediate', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    models = {
        ...
        u'captable.certificate': {
            ...
            'vesting_immediate': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'vesting_notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
